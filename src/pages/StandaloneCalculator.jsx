  ...
  return (
    <div className="min-h-screen" style={{ background: "#edf2f7" }}>
      <div style={{ background: "linear-gradient(160deg, #0d2137 0%, #1a4a7a 60%, #2b5f8a 100%)" }} className="pb-16 pt-12 px-6 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight">Discover Your Potential</h1>
        <p className="text-3xl sm:text-4xl font-bold italic mt-1" style={{ color: "#7ec8e3" }}>Annual Savings</p>
