  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200 py-5 px-6 flex items-center gap-3">
          <img
          ...
          />
          <div>
            <h1 className="text-lg font-bold text-gray-900">PreventivePay Savings Calculator</h1>
            <p className="text-xs text-gray-500">Integrated Management Group</p>
          </div>
        </div>
